    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <hr>
            It has Happen 5 year to Open and we never get Criticised for the taste of our food.We try to give service to our coustomer as much as possible
            ...
            <div class="row hello px-lg-4">
                <div class="col-lg-4 col-6 text-lg-start text-center">
                    <div>
                        ...
                        <h2 class="fs-5 fw-bolder">KHANA KHAZANA</h2></button>
    ...
    <div class="whale">
        <div class="row p-3">
            ...
            <div class="col-3 container-fluid p-0 m-0 widt">
                ...
                <p class="fiy">Khana Khazana is a culinary platform dedicated to bringing the rich and diverse flavors of Indian cuisine to food enthusiasts worldwide. Our mission is to share authentic recipes, cooking techniques, and cultural insights that celebrate India's gastronomic heritage. From traditional dishes to modern twists, we offer a wide array of recipes that cater to both novice and experienced cooks. Our team of passionate chefs and food writers is committed to providing detailed, easy-to-follow instructions, ensuring that every cooking experience is enjoyable and successful. Join us on a flavorful journey and discover the true essence of Indian cooking with Khana Khazana.</p>
            </div>
        </div>
    </div>
    <main>
        ...
        <div class="container-fluid  py-3 mob">
            <div class="row grey">
                ...
                <div class="col-lg-7 whi">
                    <hl class=" text-center whit">Enjoy <span class="wait">Delicious <br>Food </span>In your <br>Health Life</hl>
                    <p>Relish the goodness of our carefully crafted meals, designed to complement your journey to a healthier and more fulfilling life.Crafted with love, using fresh and high-quality natural ingredients.</p>
                    <a href="book.html"><button class="red-btn p-1 blue">Book Your Table <i class="fa-solid fa-arrow-right"></i></button></a>
                </div>
        ...
        <div class="row pt-3 pb-4 food-item">
            ...
            <div class="col-lg-4 col-12 mb-3 item">
                ...
                <a href="menu.html"><buttton class="white-btn">See Menu</buttton></a>
            ...
            <div class="col-lg-4 col-12 item mb-2">
                ...
                <a href="menu.html" ><buttton class="red-btn " id="red" >See Menu</buttton></a>
        ...
        <div class="row pt-2 pb-4">
            ...
            <div class="col-lg-6 col-12">
                <p class="mt-3">
                    ...
                    Our head chef, Chef Alessandro, brings a unique international flair to Khana Khazana. With years of experience in top kitchens worldwide, Chef Alessandro is renowned for his expertise in creating the perfect Biryani and Chicken Lollipop. His dedication to blending traditional Indian spices with innovative techniques has earned him recognition as one of the finest chefs, bringing authentic yet modern flavors to every dish.
                </p>
            </div>
        </div>
        <div class="row pt-2 pb-4">
            ...
            <div class="col-lg-6 col-12">
                <p class="mt-3">
                    ...
                    Our renowned chef, Chef Luca, is the culinary genius behind Khana Khazana's signature dishes. Specializing in crafting perfect Pizzas and flavorful Fried Rice, Chef Luca combines classic techniques with a creative touch. His years of experience and dedication to authentic cooking have earned him a reputation as one of the most famous chefs at Khana Khazana. With each dish, Chef Luca delivers an unforgettable dining experience filled with bold flavors and culinary expertise.
                </p>
            </div>
        </div>
        <div class="row pt-2 pb-4">
            ...
            <div class="col-lg-6 col-12">
                <p class="mt-3">
                    ...
                    Our celebrated chef, Chef Marco, is known for his exceptional skills in creating iconic dishes like Recheado Masala Fish and Kidney Bean Curry at Khana Khazana. With years of international experience, Chef Marco combines traditional Indian flavors with a global perspective. His expertise in balancing spices and creating rich, flavorful curries has made him one of the most famous chefs in our restaurant, offering a culinary experience that stands out.
                </p>
            </div>
        </div>
        ...
        <div class="row pt-2 pb-4">
            ...
            <div class="col-lg-6 col-12 what">
                <p class="mt-3">
                    ...
                    Our renowned chef, Chef Isabella, is the culinary mastermind behind some of Khana Khazana's most beloved dishes. Known for her expertise in preparing Lamb Rogan Josh and Paneer Butter Masala, Chef Isabella brings a perfect blend of traditional flavors and modern techniques to every dish. With her passion for cooking and years of experience, she has earned a well-deserved reputation as one of the finest chefs at Khana Khazana.
                </p>
            </div>
        </div>
                ...
                <div class="accordion fw-normal" id="accordionExample">
                    <div class="accordion-item mb-3">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body">We are thrilled to announce that we will soon be officially registered with Zomato. This partnership will allow us to serve you better and provide seamless access to exclusive deals and offers. Stay tuned for the official launch, and thank you for your continued support as we take this exciting step forward!
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header">
                          <button class="accordion-button collapsed fw-bolder" type="button" data-bs-toggle="collapse" data-bs-target="#flush" aria-expanded="false" aria-controls="flush-collapseOne">
                            What is our aim in comming five year
                          </button>
                        </h2>
                        <div id="flush" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body">Over the next five years, our aim is to establish our restaurant as a trusted name in the industry. We plan to expand our menu offerings, enhance customer experiences, and integrate innovative online services. By focusing on quality, consistency, and sustainability, we aim to attract a loyal customer base and grow our presence both locally and beyond.
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header">
                          <button class="accordion-button collapsed fw-bolder" type="button" data-bs-toggle="collapse" data-bs-target="#flush2" aria-expanded="false" aria-controls="flush-collapseOne">
                            Will we move on cattering
                          </button>
                        </h2>
                        <div id="flush2" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body">Currently, we are focused on providing the best dine-in and takeaway experiences for our customers. While we don’t offer catering services at the moment, it’s something we may explore in the future as we grow. Stay connected with us for updates on new services and offerings!
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header">
                          <button class="accordion-button collapsed fw-bolder" type="button" data-bs-toggle="collapse" data-bs-target="#flush1" aria-expanded="false" aria-controls="flush-collapseOne">
                            More About the Developer
                          </button>
                        </h2>
                        <div id="flush1" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body">Hello, my name is Nitish Kumar, and I am a Class 9 student with a deep passion for Robotics, Artificial Intelligence, and Web Development. I have hands-on experience in designing and programming robots, particularly using Arduino UNO boards, as well as a solid foundation in Python programming and AI principles. Additionally, I have explored both front-end and back-end web development, with projects such as a restaurant website, a Tic Tac Toe game, and a responsive clone of the Wscubetech website.Iam also an good chess player.

                            I have attended a Robotics and AI workshop, where I enhanced my skills in problem-solving and creativity. My technical toolkit includes proficiency in Python, HTML, CSS, JavaScript, and SQL, alongside tools like Git and Visual Studio Code. With a strong inclination for problem-solving, teamwork, and innovation, I am always eager to learn and embrace new challenges in technology.
        ...
        <div class="container ">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <p>On 3rd March, we proudly hosted Charity Day, bringing our community together for a meaningful cause. With every meal served, we contributed to Charity events to support local hunger relief initiatives". Guests enjoyed a special menu, live entertainment, and the joy of making a difference.
    
                        We are thrilled to announce that, thanks to your support, we raised 40000, helping to create a positive impact. Khana Khajana, we’re committed to blending great food with giving back. Thank you for joining us in making a difference!
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <p class="">On 15 January, we marked a significant milestone – the 15th anniversary of Khana Khazana! This special day was a celebration of the incredible journey we’ve shared with our wonderful guests and community.
    
                        The event featured a festive atmosphere with live music, exclusive dishes, and heartfelt moments as we reflected on the memories made over the years. We were delighted to welcome familiar faces and new ones, all coming together to honor our passion for exceptional food and hospitality.
                        
                        Thank you for making this celebration unforgettable. Here’s to many more years of delicious moments!</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-12">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <p>On 31st October, Khana Khajana hosted an unforgettable Festive Feast in celebration of  Diwali. The restaurant came alive with vibrant decorations, glowing lights, and the aroma of our signature dishes filling the air.

                        Guests enjoyed a specially curated menu featuring Shahi Paneer, along with live music and cultural performances that added to the festive charm. Families and friends gathered to create lasting memories, making the celebration truly special.
                        
                        We are grateful to everyone who joined us and made the event a grand success. Stay tuned for more exciting celebrations at Khana Khajana!</p>
                </div>
            </div>
        </div>
    </div>
    <div class="restaur pb-4">
        ...
        <div class="d-flex justify-content-center row">
            <div class="writish mb-4 mt-3 col-lg-4 col-12 mx-5">
                <img src="image/DALL·E 2025-01-15 18.13.28 - A full view of a restaurant from the outside, featuring a stylish and inviting facade with large glass windows, warm ambient lighting, and a prominent.webp" class="mt-3">
